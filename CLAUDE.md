...
The verification loop for this workspace is:
...
A change isn't done until all four pass. For new behavior, add a test that
pins it before claiming the work is finished; for a bug fix, add a test that
